      ...
      <AnimatePresence>
        {selectedApi && (
          ...
          >
            ...
            <div style={{ position: "absolute", left: 12, top: 76, width: 370, height: selectedApi.name === "OpenWeather" ? 357 : selectedApi.auth2 ? (detailBig ? 337 : 331) : (detailBig ? 295 : 289), borderRadius: 10, border: isDark ? "0.8px solid #312F2F" : "0.8px solid #f2f2f2", backgroundColor: isDark ? "#0F0F0F" : "#ffffff", boxSizing: "border-box", overflow: "hidden" }}>
            <motion.div initial="hidden" animate="visible" exit="exit" variants={cardContentVariants} style={{ position: "absolute", left: 0, top: 0, right: 0, bottom: 0 }}>
              ...
              {selectedApi.keyDesc ? (
                <motion.div variants={cardItemVariants} style={{ position: "absolute", left: 12, top: 73, width: 346, height: selectedApi.name === "OpenWeather" ? 94 : (detailBig ? 74 : 72), borderRadius: 8, outline: isDark ? "0.6px solid #844900" : "0.6px solid #FFDAAD", backgroundColor: isDark ? "#381E00" : "#FFFCFA" }}>
                  ...
                  <div style={{ position: "absolute", left: 4, top: detailBig ? 34 : 32, width: 338, height: selectedApi.name === "OpenWeather" ? 56 : (detailBig ? 36 : 36), borderRadius: 6, backgroundColor: isDark ? "#693800" : "#FFF2E0" }}>
                    <span style={{ position: "absolute", left: 8, top: 8, right: 8, fontFamily: "Geist, var(--font-geist-sans)", fontSize: detailBig ? 14 : 12, lineHeight: "20px", letterSpacing: detailBig ? "-0.56px" : "-0.48px", color: isDark ? "#FFBF73" : "#A85C00", overflow: "hidden", whiteSpace: selectedApi.name === "OpenWeather" ? "normal" : "nowrap", textOverflow: "ellipsis" }}>{selectedApi.keyDesc}</span>
                  </div>
                </motion.div>
              ) : (
