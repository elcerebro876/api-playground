      ...
      <AnimatePresence>
        {selectedApi && (
          ...
          >
            ...
            <motion.div variants={cardItemVariants} style={{ position: "absolute", left: 12, top: detailBig ? 44 : 40, display: "flex", alignItems: "center", gap: 4, borderRadius: 6, backgroundColor: isDark ? "#000053" : "#e4e4ff", padding: "4px 8px" }}>
              ...
              <span style={{ fontFamily: "Geist, var(--font-geist-sans)", fontSize: 12, fontWeight: 500, letterSpacing: "-0.6px", color: isDark ? "#C4C4FF" : "#5a5aff" }}>{selectedApi.name} Starter request</span>
            </motion.div>
            <div style={{ position: "absolute", left: 12, top: 76, width: 370, height: detailBig ? 295 : 289, borderRadius: 10, border: isDark ? "0.8px solid #312F2F" : "0.8px solid #f2f2f2", backgroundColor: isDark ? "#0F0F0F" : "#ffffff", boxSizing: "border-box", overflow: "hidden" }}>
            <motion.div initial="hidden" animate="visible" exit="exit" variants={cardContentVariants} style={{ position: "absolute", left: 0, top: 0, right: 0, bottom: 0 }}>
              ...
              <motion.span variants={cardItemVariants} style={{ position: "absolute", left: 12, top: 37, right: 12, fontFamily: "Geist, var(--font-geist-sans)", fontSize: 12, letterSpacing: "-0.48px", color: isDark ? "#F7F7F7" : "#939393", lineHeight: "20px" }}>{selectedApi.desc}</motion.span>
              {selectedApi.keyDesc ? (
                <motion.div variants={cardItemVariants} style={{ position: "absolute", left: 12, top: 73, width: 346, height: detailBig ? 74 : 72, borderRadius: 8, outline: isDark ? "0.6px solid #844900" : "0.6px solid #FFDAAD", backgroundColor: isDark ? "#381E00" : "#FFFCFA" }}>
                  ...
                  <div style={{ position: "absolute", left: 4, top: detailBig ? 34 : 32, width: 338, height: detailBig ? 36 : 36, borderRadius: 6, backgroundColor: isDark ? "#693800" : "#FFF2E0" }}>
                    <span style={{ position: "absolute", left: 8, top: 8, right: 8, fontFamily: "Geist, var(--font-geist-sans)", fontSize: detailBig ? 14 : 12, lineHeight: "20px", letterSpacing: detailBig ? "-0.56px" : "-0.48px", color: isDark ? "#FFBF73" : "#A85C00", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>{selectedApi.keyDesc}</span>
                  </div>
                </motion.div>
              ) : (
              ...
              <motion.div variants={cardItemVariants} style={{ position: "absolute", left: 12, top: detailBig ? 155 : 161, width: 346, height: detailBig ? 128 : 116, borderRadius: 8, border: isDark ? "0.8px solid #312F2F" : "0.8px solid #f2f2f2", backgroundColor: isDark ? "#0F0F0F" : "#ffffff", boxSizing: "border-box" }}>
                ...
                <div style={{ position: "absolute", left: detailBig ? 89 : 86, top: 8, width: detailBig ? 249 : 252, height: detailBig ? 34 : 28, borderRadius: 6, border: isDark ? "0.8px solid #312F2F" : "0.8px solid #f2f2f2", backgroundColor: isDark ? "#212121" : "#ffffff", boxSizing: "border-box" }}>
                  <span style={{ position: "absolute", left: 8, top: detailBig ? 8 : 6, right: 8, fontFamily: "Geist, var(--font-geist-sans)", fontSize: detailBig ? 14 : 12, letterSpacing: detailBig ? "-0.56px" : "-0.48px", color: isDark ? "#F7F7F7" : "#5E5E5E", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{selectedApi.url}</span>
                </div>
                {selectedApi.auth ? (
                  <div style={{ position: "absolute", left: 8, top: detailBig ? 50 : 44, width: 330, height: detailBig ? 34 : 28, borderRadius: 6, border: isDark ? "0.8px solid #312F2F" : "0.8px solid #f2f2f2", backgroundColor: isDark ? "#212121" : "#ffffff", boxSizing: "border-box" }}>
                    <span style={{ position: "absolute", left: 8, top: detailBig ? 8 : 6, right: 8, fontFamily: "Geist, var(--font-geist-sans)", fontSize: detailBig ? 14 : 12, letterSpacing: detailBig ? "-0.56px" : "-0.48px", color: isDark ? "#D1D1D1" : "#9e9e9e", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{selectedApi.auth}</span>
                  </div>
                ) : null}
                <RippleButton style={{ position: "absolute", left: 8, top: selectedApi.auth ? (detailBig ? 92 : 80) : (detailBig ? 50 : 44), display: "flex", alignItems: "center", gap: 4, borderRadius: 6, backgroundColor: "#5A5AFF", padding: "6px 6px", height: 28, boxSizing: "border-box" }}>
